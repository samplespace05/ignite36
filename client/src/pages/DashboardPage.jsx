...
const Header = () => (
    <header className="w-full max-w-5xl flex justify-between items-center mb-8">
        <div className="flex items-center space-x-3">
         ...
         <button 
            onClick={() => { localStorage.removeItem('session_token'); window.location.href = '/login'; }}
    ...
    return (
        <div className="bg-gray-900 text-gray-200 min-h-screen flex flex-col items-center p-4 sm:p-6 lg:p-8">
            ...
            <main className="w-full max-w-5xl bg-gray-800 rounded-xl shadow-2xl p-6 sm:p-8">
                ...
                {isLoading ? ( <div className="text-center text-gray-400 py-8">Loading dashboard...</div> ) : 
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                            {data.certificates.map((cert) => (
                                <div key={cert.id} className="bg-gray-700/50 p-4 rounded-lg flex items-center justify-between transition-shadow duration-300 hover:shadow-lg hover:shadow-indigo-900/20">
