...
const Header = () => (
    <header className="w-full max-w-md flex justify-center items-center space-x-4 mb-8">
        ...
        <div className="border-l-2 border-gray-600 h-10"></div>
    ...
    return (
        <div className="bg-gray-900 min-h-screen flex flex-col justify-center items-center p-4">
            ...
            <div className="w-full max-w-md bg-gray-800 rounded-xl shadow-2xl p-8">
                ...
                <p className="text-gray-400 text-center mb-6">Enter your registered email to receive a magic link.</p>
                ...
                {message && <div className="mt-4 text-center text-green-400 bg-green-900/50 p-3 rounded-lg">{message}</div>}
